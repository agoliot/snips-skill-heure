...
def intent_received(hermes, intent_message):
	...
	if intent_message.intent.intent_name == 'agoliot:askTime':
		...
		# hermes.publish_continue_session(intent_message.session_id, sentence, ["agoliot:greetings"])
		hermes.publish_end_session(intent_message.session_id, sentence)

	elif intent_message.intent.intent_name == 'agoliot:greetings':
